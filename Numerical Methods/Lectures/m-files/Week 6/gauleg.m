...
% [x, w] = gauleg(n, a, b)
% MATH2089: File = gauleg.m
% Calculate the n Gauss-Legendre quadrature points x and weights w
% for the interval [a, b]
% If no interval [a, b] is specified default interval [-1, 1] is used
% This function implements Newton;s method from good starting points
...
% 1967 Stanford CS Report, 1969 Maths. Comp.
% However Matlab does not have a tridiagonal eigenvalue solver
...
% Newton's method for zeros simultaneously
ztol = eps;
itmax = 20;
it = 0;
iterate = 1;
...
% Scale roots and add symmetric counterparts
if n==2*m
   nz = m;
else 
   nz = m-1;
